(() => {
  ...
  import_webextension_polyfill_ts2.browser.runtime.onInstalled.addListener((details) => {
    if (details.reason === "install") {
      console.log("Extension installed");
      import_webextension_polyfill_ts2.browser.storage.local.set({ options: defaultOptions });
    }
  });
  onMessage("browser-media-scheme", (e) => {
    import_webextension_polyfill_ts2.browser.browserAction.setIcon({
